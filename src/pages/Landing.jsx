    ...
    return (
        ...
        <>
            ...
            <div className='d-flex align-items-center justify-content-center flex-column first-section' >
               ...
               <Link to={'/newContact'}> <Button variant="contained" style={{ backgroundColor: 'rgba(129, 99, 218, 1)', marginTop: '80px', padding: '15px' }}>Start creating new contacts</Button></Link>
            ...
            <div>
                ...
                <Box sx={{ flexGrow: 1 }} className='startnow' >
                    <Grid container spacing={10}>
                        ...
                        <Grid size={{md:5,sm:12}}  className='d-flex align-items-center justify-content-center flex-column'>
                        ...
                        <Grid size={{md:5,sm:12}}  className='d-flex align-items-center justify-content-center '>
                            <Paper className='d-flex justify-content-center align-items-center flex-column' elevation={3} sx={{ width: '75%', height: '250px', padding: '30px',textAlign:'center' }}>
